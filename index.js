...
if(gender === "Male"){
    ...
    document.getElementById("output").innerHTML=("If you were born on "     + Day +    " your name is " + Mname);

} else if(gender === "Female") {
   
        var Fname = femaleName[Dayoftheweek - 1];
        var Day = Days[Dayoftheweek - 1];
        document.getElementById("output").innerHTML=("If you were born on "     + Day +    " your name is " + Fname);
    }
}
myfunction();